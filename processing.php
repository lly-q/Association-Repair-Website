...
?>
<form action="dealFinal.php" method="post" accept-charset="utf-8">
	<table border="1">
		<caption>维修中的单子</caption>
		<thead>
			<tr>
				<th>姓名</th>
				<th>宿舍号</th>
			 ...
			 <?php
                ...
                ?>
                    <tr>
                        ...
                        <td class="center"><?php echo $result['repair'];?>
                        <a href="./dealFinal.php?num=<?php echo $result['num']; ?>">结单</a>
