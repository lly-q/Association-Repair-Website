...
<nav class="menu-wrap">
	...
	<div class="menu">
		<ul>
			<li>
				<a href="./overviewReviewer.php"  target="mainFrame">
					<i class="fa fa-home fa-lg"></i>
					<span class="nav-text">总览</span>
				</a>
			</li>
			<li>
				<a href="./pendingReviewer.php" target="mainFrame">
					<i class="fa fa-envelope-o fa-lg"></i>
					<span class="nav-text">待审核</span>
				</a>
			</li>
			<li>
				<a href="./solvedReviewer.php"  target="mainFrame">
					<i class="fa fa-envelope-open-o fa-lg"></i>
					<span class="nav-text">已审核</span>
				</a>
			</li>
			<li>
				<a href="../processing.php"  target="mainFrame">
					<i class="fa fa-folder-open fa-lg"></i>
					<span class="nav-text">修理中</span>
				</a>
			</li>
			<li>
				<a href="../options.php"  target="mainFrame">
...
?>
	...
	<iframe scrolling="yes" id="mainFrame" name="mainFrame" frameborder="0" style="width:100%;min-height:600px;overflow:visible;background:#fff;" src="overviewReviewer.php"></iframe>
</div>
